...
// 확장한 예비 채널이라는 프로젝트 공통 규약(ChannelViewerOverlay, ChannelSelectDrawer가 공유).
...
export const CHANNEL_COLORS = ["#0B4171", "#6B9BD1", "#10B981", "#F97316", "#0EA5E9", "#EC4899", "#84CC16", "#F43F5E"];
