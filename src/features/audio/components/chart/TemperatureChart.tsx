...
export default function TemperatureChart({ store, isActive, audioDuration, perfTrack = false, onExpand, warnThreshold = DEFAULT_TEMP_WARN, dangerThreshold = DEFAULT_TEMP_DANGER }: Props) {
  const {
    current: currentTemp,
    timeDecimals,
    onRender,
