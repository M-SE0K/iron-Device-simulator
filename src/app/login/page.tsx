...
// useSearchParams() 는 Next.js 15 에서 <Suspense> 경계 안에서만 프리렌더 가능 →
// 실제 폼은 LoginForm 으로 분리하고 기본 export 에서 Suspense 로 감싼다.
function LoginForm() {
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-iron-50" />}>
      <LoginForm />
    </Suspense>
  );
}
